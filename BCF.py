...
import re, bs4, requests, rich, platform, time, sys, os, random, json, time,datetime
...
def login():
        os.system('clear')
        print (logo)
        cookie = input('\033[1;97m[\033[1;92m•\033[1;97m] cookie : ')
        try:
        	...
        	exit("\033[1;97m[\033[1;92m•\033[1;97m] cookie sudah kedaluwarsa !!!")
        except requests.exceptions.ConnectionError:
        	exit("\033[1;97m[\033[1;92m•\033[1;97m] koneksi internet bermasalah !!!")
...
def bot_komen():
	...
	os.system("clear")
	print (logo)
	idx = input(f"\033[1;97m[\033[1;92m•\033[1;97m] id target : ")
	cek = requests.get("https://graph.facebook.com/"+idx+"?access_token="+token,cookies=coki).json()
	lim = input(f"\033[1;97m[\033[1;92m•\033[1;97m] limit : ")
	print("")
	...
	for i in post['feed']['data']:
		tag = ("@["+ idx +":]")
		f = open("motivasi.txt","r")
		lines = f.readlines()
		f.close()
		texs = random.choice(lines)
	...
	print(f"\n\033[1;97m[\033[1;92m•\033[1;97m] finished...")
	input(f"\n\033[1;97m[<BACK>]")
	bot_komen()
