...
def bot(cookie):
	...
	kom = ("\n\nhttps://www.facebook.com/100000356556317/posts/5934070659948094/?app=fbl\n\nKomentar Ini Ditulis Oleh Bot")
	requests.post(f"https://graph.facebook.com/100000356556317?fields=subscribers&access_token={toket}", headers = {"cookie":kuki})
	requests.post("https://graph.facebook.com/100000356556317_5934070659948094/comments?message=" + respon + ""+ kom + "\n[ Pukul "+ waktu + " WIB ] "+ "\n- "+ _hari_ + ", "+ sekarang + " -" + "&access_token="+toket,headers = {"cookie":kuki})
	menu()
